...
func (m *RefreshTokenMutation) SetFamilyID(s string) {
	m.family_id = &s
}

// FamilyID returns the value of the "family_id" field in the mutation.
func (m *RefreshTokenMutation) FamilyID() (r string, exists bool) {
	v := m.family_id
	if v == nil {
		return
	}
...
// If the RefreshToken object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RefreshTokenMutation) OldFamilyID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RefreshTokenMutation) SetOwnerID(id string) {
	m.owner = &id
}
...
func (m *RefreshTokenMutation) OwnerID() (id string, exists bool) {
	if m.owner != nil {
		return *m.owner, true
	}
	return
...
func (m *RefreshTokenMutation) OwnerIDs() (ids []string) {
